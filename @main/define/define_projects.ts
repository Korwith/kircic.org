...
const project_data: ProjectEntryList = {
    'Wordle': {
        ...
        image: { icon: '../icon/wordle.png', size: '75%' },
    ...
    'Infinisweeper': {
        ...
        image: { icon: '../icon/infinisweeper.png', size: '75%' },
    ...
    'Minesweeper': {
        ...
        image: { icon: '../icon/minesweeper.png', size: '75%' },
    ...
    '3D Viewer': {
        ...
        image: { icon: '../icon/3dviewer.svg', size: '80%' },
    ...
    'Letter Boxed': {
        ...
        image: { icon: '../icon/letterboxed.svg', size: '105%' },
    ...
    'Notilify': {
        ...
        image: { icon: '../icon/notilify.png', size: '90%' },
    ...
    'Stock Tracker': {
        ...
        image: { icon: '../icon/stock.svg', size: '90%' },
